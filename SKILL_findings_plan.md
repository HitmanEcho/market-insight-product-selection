...
| **Project directory** | follow system context | `task_plan.md`, `findings.md`, analysis outputs, charts |
...
|----------|------------|---------|----------------|
| `task_plan.md` | `/home/wuying/skills/market-insight-product-selection-v2/templates/task_plan.md` | Phase tracking, decisions, errors | After each phase completes |
...
|------|----------------|--------------|
| `task_plan.md` | Your roadmap — phases, progress, decisions | Goal, Phases (pending/in_progress/complete), Decisions Made, Errors Encountered |
...
1. **Create `task_plan.md`** — Define scope, market, timeframe, constraints
2. **Create `findings.md`** — Store VoC samples, signals, evidence
3. **Follow the 4-step pipeline**:
   - Trend Radar → Top Picks → Deep Dive Packs → Decision & Action
4. **Re-read plan before decisions** — Refreshes goals in attention window
5. **Update after each phase** — Mark phase complete, log data gaps in `task_plan.md`
6. **Save evidence to `findings.md`** — VoC samples, signals, research discoveries
...
- [ ] **Re-read `task_plan.md`** before major decisions (attention refresh)
...
### ❌ Avoid
- Starting without creating `task_plan.md` and `findings.md`
